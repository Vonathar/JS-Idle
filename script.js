...
const laptopIcon = document.body.querySelector("#laptopIcon");
const clickPowerParagraph = document.body.querySelector("#clickPowerParagraph");
const xpMultiplierParagraph = document.body.querySelector("#xpMultiplierParagraph");
const currentCharParagraph = document.body.querySelector("#currentCharParagraph");
const charPerSecondParagraph = document.body.querySelector("#charPerSecondParagraph");
const userLevelProgressBar = document.body.querySelector("#userLevelProgressBar");
const userLevelParagraph = document.body.querySelector("#userLevelParagraph");
const developerOneParagraph = document.body.querySelector("#developerOneParagraph");
const developerTwoParagraph = document.body.querySelector("#developerTwoParagraph");
const developerThreeParagraph = document.body.querySelector("#developerThreeParagraph");
const developerFourParagraph = document.body.querySelector("#developerFourParagraph");
const developerFiveParagraph = document.body.querySelector("#developerFiveParagraph");
const developerSixParagraph = document.body.querySelector("#developerSixParagraph");
const developerSevenParagraph = document.body.querySelector("#developerSevenParagraph");
const developerEightParagraph = document.body.querySelector("#developerEightParagraph");
const developerNineParagraph = document.body.querySelector("#developerNineParagraph");
const developerTenParagraph = document.body.querySelector("#developerTenParagraph");
const developerElevenParagraph = document.body.querySelector("#developerElevenParagraph");
...
const developerElevenImage = document.body.querySelector("#developerElevenImage");
...
const upgradeThreeParagraph = document.body.querySelector("#upgradeThreeParagraph");
const upgradeFoureParagraph = document.body.querySelector("#upgradeFourParagraph");
const upgradeFiveParagraph = document.body.querySelector("#upgradeFiveParagraph");
const upgradeSixParagraph = document.body.querySelector("#upgradeSixParagraph");
const upgradeSevenParagraph = document.body.querySelector("#upgradeSevenParagraph");
const upgradeEightParagraph = document.body.querySelector("#upgradeEightParagraph");
